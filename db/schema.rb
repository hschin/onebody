...
ActiveRecord::Schema.define(version: 20181006151831) do
  ...
  create_table "offering_reports", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci" do |t|
    t.date "report_date"
  ...
  create_table "offerings", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci" do |t|
    t.date "date"
    t.integer "person_id"
    t.integer "family_id"
    ...
    t.integer "offering_report_id"
    t.index ["family_id"], name: "index_offerings_on_family_id"
    t.index ["person_id"], name: "index_offerings_on_person_id"
  end
  ...
  create_table "people", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci" do |t|
    ...
    t.date "membership_transfer_date"
